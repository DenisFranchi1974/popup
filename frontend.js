document.addEventListener('DOMContentLoaded', function() {
    ...
    // Ottenere l'elemento con attributo data-popup-id
    const popupElement = document.querySelector('[data-popup-id]');
 
    // Verifica se l'elemento è valido e se ha l'attributo data-popup-id
    if (popupElement && popupElement.getAttribute('data-popup-id')) {
             // Ottenere l'ID dinamico del popup
             ...
             // Verifica il valore di popupId
 console.log('popupId:', popupId);
 
 // Verifica l'elemento selezionato con data-popup-id
 const popupElementWithDataId = document.querySelector(`[data-popup-id="${popupId}"]`);
 console.log('Popup Element with data-popup-id:', popupElementWithDataId);
 
 // Verifica l'elemento selezionato con l'ID
 const popupElementWithId = document.getElementById(popupId);
 console.log('Popup Element with ID:', popupElementWithId);
             ...
             // Funzione per gestire la chiusura del popup e aggiornare il conteggio
             ...
             // Funzione per gestire la chiusura del popup e aggiornare il conteggio delle chiusure
             function closePopup() {}
